...
export const Route = createFileRoute("/registro")({
  head: () => ({
    meta: [
      { title: "Crear cuenta — Tú Escenario Digital" },
      {
        name: "description",
        content:
          "Crea tu perfil de artista o promotor en TUESDI. Conecta con talento o encuentra tu próximo evento.",
      },
    ],
  }),
...
const ORGANIZER_PERKS = [
  "Acceso a la agenda cultural de TUESDI",
      ...
      <main className="mx-auto grid max-w-6xl gap-12 px-6 pt-12 pb-20 md:grid-cols-[1.1fr_1fr] md:pt-20">
        ...
        <aside className="hidden md:block">
          ...
          <p className="mt-5 max-w-md text-muted-foreground">
            {role === "artist"
              ? "Estamos lanzando TUESDI. Durante la beta, los artistas se publican gratis. Nosotros somos solo intermediarios: tú cobras directamente del cliente."
              : role === "organizer"
