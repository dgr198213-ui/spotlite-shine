  ...
  return (
    <div className="min-h-dvh bg-background">
      ...
      <main className="mx-auto max-w-4xl px-6 pt-12 pb-24">
        ...
        <h1 className="mt-3 font-display text-5xl tracking-tight">Términos y Condiciones</h1>
        ...
        <article className="mt-12 space-y-10 text-sm leading-relaxed">
          ...
          <section>
            ...
            <p className="mt-4 text-muted-foreground">
              Los planes de suscripción (Free, Standard, Pro) incluyen diferentes
          ...
          <section>
            ...
            <p className="mt-4 text-muted-foreground">No debes utilizar la Plataforma para:</p>
            <ul className="mt-4 space-y-2 text-muted-foreground list-disc list-inside">
