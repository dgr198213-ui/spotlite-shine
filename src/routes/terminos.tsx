...
export const Route = createFileRoute("/terminos")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Términos y condiciones de uso de la plataforma Spot&Shows." },
    ],
  }),
        ...
        <article className="mt-10 space-y-8 text-sm leading-relaxed">
          <section>
            ...
            <p className="mt-3 text-muted-foreground">
              Al acceder y utilizar Spot&Shows ("la Plataforma"), aceptas estar vinculado por estos Términos y Condiciones. Si no estás de acuerdo con alguno de estos términos, no debes utilizar la Plataforma.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3 text-muted-foreground">
              Spot&Shows es una plataforma digital que facilita la conexión entre artistas y promotores de eventos. Spot&Shows actúa únicamente como intermediario y no es responsable de:
            </p>
          ...
          <section>
            ...
            <p className="mt-3 text-muted-foreground">
              La Plataforma ofrece dos roles principales: Artistas y Promotores. Cada rol tiene responsabilidades y limitaciones específicas. Al registrarte, aceptas cumplir con las obligaciones de tu rol seleccionado.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3 text-muted-foreground">
              Los planes de suscripción (Spark, Spotlight, Headliner) incluyen diferentes funcionalidades y límites de contenido. Las suscripciones se renuevan automáticamente al final de cada período de facturación. Puedes cancelar tu suscripción en cualquier momento desde tu panel de control.
            </p>
            <p className="mt-3 text-muted-foreground">
              No se ofrecen reembolsos por períodos parciales. La cancelación entrará en vigor al final del período de facturación actual.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3 text-muted-foreground">
              Eres responsable de todo el contenido que publiques en la Plataforma, incluyendo fotos, vídeos, descripciones y perfiles. Garantizas que:
            </p>
            <ul className="mt-3 space-y-2 text-muted-foreground list-disc list-inside">
          ...
          <section>
            ...
            <p className="mt-3 text-muted-foreground">
              Spot&Shows se proporciona "tal cual" sin garantías de ningún tipo. No somos responsables de:
            </p>
            <ul className="mt-3 space-y-2 text-muted-foreground list-disc list-inside">
          ...
          <section>
            ...
            <p className="mt-3 text-muted-foreground">
              Spot&Shows se reserva el derecho de modificar estos Términos en cualquier momento. Los cambios entrarán en vigor inmediatamente. Tu uso continuado de la Plataforma constituye aceptación de los términos modificados.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-3 text-muted-foreground">
              Para preguntas sobre estos Términos, contáctanos en: <a href="mailto:legal@spotandshows.com" className="text-gold hover:underline">legal@spotandshows.com</a>
            </p>
          </section>
        </article>
      </main>
