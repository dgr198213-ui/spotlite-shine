...
export const Route = createFileRoute("/cookies")({
  head: () => ({
    meta: [
      { title: "Política de Cookies — TUESDI" },
      {
        name: "description",
        content:
          "Política de cookies de TUESDI. Información sobre el uso de cookies y tecnologías de rastreo.",
      },
    ],
  }),
      ...
      <main className="mx-auto max-w-4xl px-6 pt-12 pb-20">
        ...
        <article className="mt-10 space-y-8 text-sm leading-relaxed">
          ...
          <section>
            ...
            <div className="mt-4 space-y-4">
              ...
              <div>
                ...
                <p className="mt-2 text-muted-foreground">Establecidas por servicios integrados:</p>
                <ul className="mt-2 space-y-1 text-muted-foreground list-disc list-inside">
                  <li>
          ...
          <section>
            ...
            <p className="mt-3 text-muted-foreground">
              Al acceder a TUESDI, aceptas el uso de cookies esenciales. Las cookies de análisis
          ...
          <section>
            ...
            <ul className="mt-3 space-y-2 text-muted-foreground list-disc list-inside">
              ...
              <li>
                <strong>Preferencias de TUESDI:</strong> Gestiona tus preferencias desde tu
                perfil
              </li>
            </ul>
            <p className="mt-3 text-muted-foreground">
