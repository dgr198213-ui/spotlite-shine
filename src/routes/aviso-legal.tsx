  ...
  return (
    <div className="min-h-dvh bg-background">
      ...
      <main className="mx-auto max-w-4xl px-6 pt-12 pb-24">
        ...
        <h1 className="mt-3 font-display text-5xl tracking-tight">Aviso Legal</h1>
        ...
        <article className="mt-12 space-y-10 text-sm leading-relaxed">
          <section>
            ...
            <div className="mt-4 space-y-2 text-muted-foreground">
              ...
              <p>
                ...
                <a href="mailto:legal@escenika.com" className="text-primary hover:underline">
                  legal@escenika.com
                </a>
              </p>
              <p>
          ...
          <section>
            ...
            <p className="mt-4 text-muted-foreground">Escénika no es responsable de:</p>
          ...
          <section>
            ...
            <p className="mt-4 text-muted-foreground">Al utilizar la Plataforma, aceptas no:</p>
            <ul className="mt-4 space-y-2 text-muted-foreground list-disc list-inside">
          ...
          <section>
            ...
            <div className="mt-4 space-y-2 text-muted-foreground">
              <p>
                <strong>Email:</strong>{" "}
                <a href="mailto:abuse@escenika.com" className="text-primary hover:underline">
                  abuse@escenika.com
                </a>
              </p>
              <p>
          ...
          <section>
            ...
            <p className="mt-4 text-muted-foreground">Escénika cumple con:</p>
            <ul className="mt-4 space-y-2 text-muted-foreground list-disc list-inside">
